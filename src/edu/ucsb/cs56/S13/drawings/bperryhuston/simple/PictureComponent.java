package edu.ucsb.cs56.S13.drawings.bperryhuston.simple;
...
/**
   ...
   @author Bronwyn Perry-Huston (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Bronwyn Perry-Huston", 20,40);
    }
